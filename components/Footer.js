...
const Footer = () => {
    const styles = {
        wrapper: " border-t-[1px] border-gray-200 py-4 mt-6",
    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.content}>
                <footer className="bg-white pt-4 lg:pt-[2rem] pb-10 lg:pb-4 relative z-10">
                    <div className="container">
                        <div className="flex flex-wrap -mx-4">
                            ...
                            <div className="w-full sm:w-1/2 lg:w-2/12 px-4">
                                <div className="w-full mb-10">
                                    <h4 className="text-dark text-lg font-semibold mb-9">Resources</h4>
                                    <ul>
                                        <li>
                                            <a
                                                href="javascript:void(0)"
                     ...
                     "
                                    ...
                                    <p className="text-base text-body-color">&copy; 2025 TechRealm</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <span className="absolute top-0 right-10 z-[-1]">
                            <svg
                                width="75"
                                height="75"
                                viewBox="0 0 75 75"
